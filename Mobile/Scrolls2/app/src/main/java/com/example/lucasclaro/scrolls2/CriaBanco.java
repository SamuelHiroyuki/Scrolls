...
public class CriaBanco extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE CartaoCli(_IdCartaoCli INTEGER PRIMARY KEY AUTOINCREMENT, FOREIGN KEY (_IdCli) REFERENCES Cliente(IdCliente),FOREIGN KEY (IdCartao) REFERENCES Endereco(_IdCart))");
        ...
        db.execSQL("CREATE TABLE EnderecoCli(_IdEnderecoCli INTEGER PRIMARY KEY AUTOINCREMENT, FOREIGN KEY (_IdCli) REFERENCES Cliente(IdCliente),FOREIGN KEY (IdEndereco) REFERENCES Endereco(_IdEnd))");
    }
