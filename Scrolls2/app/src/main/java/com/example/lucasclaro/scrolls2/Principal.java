...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // imgLivro1 = (ImageView) findViewById(R.id.);
        ...
        Intent passado = getIntent();
        ClienteClass defaulta = new ClienteClass();
        int Id = passado.getIntExtra("Cliente", 0);
        cliente = dao.PegaCliente(Id);
